...
**Proyecto Final – AI Automation – Augusto Parajón**

---

## Prompt 1 – Analyze Image (Rama A)
...
## Prompt 2 – Análisis de destino logístico (Rama A)
...
## Prompt 3 – Interpretación de correos de compradores (Rama D)
...
Recibirás un JSON donde `bodyText` contiene todo el contenido del correo ya convertido a texto plano.  
Debes analizar únicamente ese contenido.
...
No uses bloques de código en la respuesta final.  
